                ...
                {errorCode === 'NO_API_KEY' && (
                  <div className="mt-4 p-3.5 bg-slate-950/80 border border-slate-800 rounded-lg text-xs text-slate-300 space-y-2">
                    ...
                    <ul className="list-disc pl-4 space-y-1 text-slate-400">
                      <li>Open your Vercel project and go to <code className="text-indigo-300 font-mono">Settings → Environment Variables</code>.</li>
                      <li>Add <code className="text-indigo-300 font-mono">SERPAPI_KEY</code> for Production and Preview, then redeploy.</li>
